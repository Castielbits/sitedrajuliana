          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-bark/80 font-sans text-sm md:text-base pr-4">
               <li className="flex items-start gap-3">
                 ...
                 <span>Experiência em atender pacientes de todas as faixas etárias.</span>
               </li>
               <li className="flex items-start gap-3">
                 <div className="w-1.5 h-1.5 rounded-full bg-[#3c787e] mt-2 shrink-0 border border-[#1e5258]" />
                 <span>A maior referência entre os médicos na área de ATM e dor orofacial em Belo Horizonte.</span>
               </li>
               <li className="flex items-start gap-3">
                 <div className="w-1.5 h-1.5 rounded-full bg-[#3c787e] mt-2 shrink-0 border border-[#1e5258]" />
