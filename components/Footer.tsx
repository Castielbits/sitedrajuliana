      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-sm text-[var(--color-sand)]/70 leading-relaxed max-w-xs mb-6">
            Excelência em fisioterapia, tratamento especializado em DTM, Bruxismo e reabilitação de alta performance. O ritmo natural da sua cura.
          </p>
          <div className="flex gap-4">
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2 border border-[var(--color-sand)]/20 rounded-full hover:bg-[var(--color-sand)]/10 hover:border-[var(--color-sand)]/40 transition-all duration-300">
              <Instagram className="w-5 h-5 text-[var(--color-sand)]/90" />
            </a>
          </div>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <ul className="flex flex-col gap-4 text-sm text-[var(--color-sand)]/70">
            <li className="flex items-start gap-3">
              ...
              <a href="tel:+5531999999999" className="hover:text-[var(--color-sand)] transition-colors">(31) 99999-9999</a>
            </li>
            <li className="flex items-start gap-3">
