...
const cards = [
  {
    id: "physio",
    title: "Physiotherapy",
    body: "Structural realignment through manual precision",
    calmSection: false,
    icon: (
      <svg
        width="32"
  ...
  },
  {
    id: "nlp",
    title: "NLP",
    body: "Reprogramming pain responses at their neurological origin",
    calmSection: true,
    icon: (
      <svg
        width="32"
  ...
  },
  {
    id: "meditation",
    title: "Meditation",
    body: "Restoring the nervous system's baseline",
    calmSection: true,
    icon: (
      <svg
        width="32"
  ...
  },
  {
    id: "acupuncture",
    title: "Acupuncture",
    body: "Ancient pathways, modern pain science",
    calmSection: false,
    icon: (
      <svg
        width="32"
...
export default function RootCause() {
  return (
    <section
      ...
      aria-label="Our multidisciplinary approach"
    >
      ...
      <div className="max-w-5xl mx-auto px-6 pt-28 pb-24">
        ...
        >
          ...
          >
            Four disciplines working together to address pain at its source —
